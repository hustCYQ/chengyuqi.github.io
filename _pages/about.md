...
<h2>
  <a href="#Robotics"><u>Robotics</u></a>&nbsp; <br> 
  <a href="#3D-CV"><u>3D CV</u></a>&nbsp; <br>
  <a href="#2D-CV"><u>2D CV</u></a>&nbsp; <br>
</h2>
...
<ol>
  ...
  <li id="OT-Manuscript3"> 
    ...
    Qingyu Peng, Wenlong Li*, Cheng Jiang, <span style="color:#b02418; font-weight:bold;">Yuqi Cheng</span>, Dongfang Wang, Wei Xu <br>
    <i>IEEE/ASME Transactions on Mechatronics <strong>(IEEE/ASME TMECH)</strong></i>. 2024. (中科院Top)
  </li>

  <li id="OT-Manuscript3"> 
    A Robotic Milling Posture Optimization Method Based on Physics-Informed Dynamic Stiffness Model and Graph Optimization Algorithm <br> 
    Qingyu Peng, Wenlong Li*, Wei Xu, Hanyu Zhang, Dongfang Wang, Cheng Jiang, <span style="color:#b02418; font-weight:bold;">Yuqi Cheng</span>, Han Ding <br>
    <i>IEEE/ASME Transactions on Mechatronics <strong>(IEEE/ASME TMECH)</strong></i>. 2024. (中科院Top)
  </li>

  <li id="OT-Manuscript3"> 
    Active Observation for Robust Visual Servoing in Robotic Manipulation <br> 
    Zhilun Hu, <span style="color:#b02418; font-weight:bold;">Yuqi Cheng</span>, Yuxiang Tan, Wen-pan Li, Weiming Shen* <br>
    <i>IEEE 22th International Conference on Automation Science and Engineering <strong>(CASE).</strong></i> 2026.
  </li>
...
<h2 id="3D-CV" style="color: #2c4a88; padding-top: 60px; margin-top: -60px;">3D-CV</h2>
<ol>
  ...
  <li id="FA-Manuscript1"> 
    ...
    <i>IEEE Transactions on Systems, Man, and Cybernetics: Systems <strong>(IEEE TSMC)</strong></i> 2025. (中科院Top)
  </li>
  ...
  <li id="FA-Manuscript1"> 
    ...
    <i>Journal of Manufacturing Systems <strong>(JMS)</strong></i> 2025. (中科院Top)
  </li>
  ...
  <li id="FA-Manuscript1"> 
    ...
    <i>IEEE Transactions on Automation Science and Engineering <strong>(IEEE TASE)</strong></i> 2025. (中科院Top)
  </li>
...
<h2 id="2D-CV" style="color: #2c4a88; padding-top: 60px; margin-top: -60px;">2D-CV</h2>
<ol>
  ...
  <li id="FA-Manuscript1"> 
    ...
    <i>Pattern Recognition. </i> (中科院Top)
  </li>

  <li id="FA-Manuscript1"> 
    Multi-View Multi-Illumination Anomaly Detection: An Empirical Study on 𝑀2𝐴𝐷 Dataset <br> 
     Yuxin Zhang#, <span style="color:#b02418; font-weight:bold;">Yuqi Cheng#</span>, Yunkang Cao, Weiming Shen* <br>
    <i>Submitted to Elsevier. </i> 
  </li>
  ...
  <li id="FA-Manuscript5"> 
    ...
    <i>IEEE Transactions on Cybernetics <strong>(IEEE TCYB)</strong></i>. 2025. (中科院Top)
  </li>
  ...
  <li id="OT-Manuscript3"> 
    ...
    <i>IEEE Transactions on Cybernetics <strong>(IEEE TCYB)</strong></i>. 2026. (中科院Top)
  </li>
  ...
  <li id="FA-Pub5"> 
    Synergistic Appearance–Geometry Reconstruction for Multi-Illumination Anomaly Detection  <br> 
    Yuxin Zhang, <span style="color:#b02418; font-weight:bold;">Yuqi Cheng</span>, Yuhan zhang, Yunkang Cao, Weiming Shen* <br>
    <i>IEEE 22th International Conference on Automation Science and Engineering <strong>(CASE).</strong></i> 2026.
  </li>
...
# 🥇 Honors and Awards
- **Gold Award** at the China Association of Invention - Invention Exhibition (**中国发明协会展览金奖**).
...
- **National Grand Prize**, National AI Application Scenario Innovation Challenge.
...
- **Future S.T.A.R.** (Highest honors in School of Mechanical Science and Engineering). 2024. 
...
# 🎓📚 Academic Service 
- **Journal Reviewer**: 20+ IEEE Trans. including TPAMI, TIP, TCYB, TSMC, TCSVT, TNNLS, TASE, TMM, etc.
- **Conference Reviewer**: CVPR, NeurIPS, ICCV, AAAI, ICRA, IROS, etc.

# 📖 Educations


| Period | Institution | Degree | Advisor |
|-------|-------------|--------|---------|
| 2023.09 – present | Huazhong University of Science and Technology, State Key Laboratory of Digital Manufacturing Equipment and Technology | Ph.D. in Mechanical Engineering | [Weiming Shen](https://scholar.google.com/citations?hl=zh-CN&user=FuSHsx4AAAAJ&view_op=list_works&sortby=pubdate) |
| 2020.09 – 2023.06 | Huazhong University of Science and Technology, State Key Laboratory of Digital Manufacturing Equipment and Technology | M.S. in Mechanical Engineering | [Wenlong Li](http://mse.hust.edu.cn/info/1142/1340.htm) |
